...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # lists "1: Buy peacock feathers" as an item in the to-do list
        ...
        # belonging to Edith is coming through from cookies
        self.browser.quit()
        self.browser = webdriver.Firefox
        ...
        # Edith's list
        self.browser.get(self.live_server_url)
        page_text = self.browser_find_element_by_tag_name('body').text
